...
(37, 'databack_reduction', '还原数据库', ''),
(38, 'wechat_config_editor', '修改微信配置', ''),
(39, 'wechat_keyword_added', '添加微信回复', ''),
(40, 'wechat_keyword_editor', '编辑微信回复', ''),
(41, 'wechat_keyword_remove', '删除微信回复', ''),
(42, 'wechat_keyword_auto', '编辑微信自动回复', ''),
(43, 'wechat_keyword_attention', '编辑微信关注回复', ''),
(44, 'banner_added', '添加幻灯片', ''),
(45, 'banner_image_added', '添加幻灯片图片', ''),
(46, 'banner_editor', '编辑幻灯片', ''),
(47, 'banner_image_editor', '编辑幻灯片图片', ''),
(48, 'banner_remove', '删除幻灯片', ''),
(49, 'banner_image_remove', '删除幻灯片图片', ''),
(50, 'ads_added', '添加广告', ''),
(51, 'ads_editor', '编辑广告', ''),
(52, 'ads_remove', '删除广告', ''),
(53, 'comment_editor', '编辑评论', ''),
(54, 'comment_remove', '删除评论', ''),
(55, 'type_added', '添加分类', ''),
(56, 'type_editor', '编辑分类', ''),
(57, 'type_remove', '删除分类', ''),
(58, 'content_sort', '内容排序', ''),
(59, 'content_added', '添加内容', ''),
(60, 'content_editor', '编辑内容', ''),
(61, 'content_recycle', '删除内容到回收站', ''),
(62, 'content_reduction', '还原内容', ''),
(63, 'content_remove', '删除内容', ''),
(64, 'theme_editor', '编辑模板', ''),
(65, 'upload_file', '上传文件', '');
