...
use think\Request;
use think\Lang;
use app\admin\model\MallCategory as ModelMallCategory;
...
class MallCategory
{
    ...
    public function getListData()
    {
        ...
        $category = new ModelMallCategory;
        $result =
        $category->view('mall_type mt', 'id,pid,name,sort')
    ...
    public function getEditorData()
    {
        ...
        $category = new ModelMallCategory;
        $result =
        $category->view('mall_type mt', true)
